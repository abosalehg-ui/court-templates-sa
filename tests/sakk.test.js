...
const MERGE_CASES = [
    ...
    // ===== امتدادات نسخة 5.5: الصلاة على النبي، «لذلك/لذا»، الواو المفردة =====
    ['7م- التوفيق + الصلاة على النبي + افتتاح الجلسة',
        'هذا وبالله التوفيق وصلى الله على نبينا محمد وآله وصحبه وسلم. افتتحت الجلسة وفيها حضر المدعي',
        'وفي جلسة أخرى حضر المدعي'],
    ['8م- التوفيق + الصلاة (بصيغة: وصلى الله وسلم … أجمعين) + في هذه الجلسة',
        'وبالله التوفيق وصلى الله وسلم على نبينا محمد وآله وصحبه أجمعين. وفي هذه الجلسة حضر المدعي',
        'وفي جلسة أخرى حضر المدعي'],
    ['9م- رفعت الجلسة لذلك + افتتاح (يحفظ المقدمة)',
        'رفعت الجلسة لذلك. افتتحت الجلسة وفيها حضر المدعى عليه',
        'رفعت الجلسة لذلك. وفي جلسة أخرى حضر المدعى عليه'],
    ['10م- رفعت الجلسة لذا + في هذه الجلسة (يحفظ المقدمة)',
        'رفعت الجلسة لذا وفي هذه الجلسة حضر المدعى عليه',
        'رفعت الجلسة لذا. وفي جلسة أخرى حضر المدعى عليه'],
    ['1م- الواو المفردة بعد «وفيها» تُبتلع مع عبارة الافتتاح',
        'وكان ختامها الساعة 9:00 صباحاً. افتتحت الجلسة وفيها و حضر المدعي',
        'وفي جلسة أخرى حضر المدعي']
];
